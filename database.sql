...
--
-- Servidor: localhost
-- Tiempo de generación: 10-02-2018 a las 10:30:05
...
(11, 15, 1, 'asd', '<p>asd</p>\r\n', '<p>asd</p>\r\n', NULL, 'R0jepITBRiHCSGNLljfDB6yQTkIjPwQT.jpg', '3.2', '', 1, 0, '2018-01-08 22:44:05', NULL, 1, '', 0),
(12, 31, 2, 'Bikini de tela hermosa', '', '', NULL, 'A6spa8YkEsgqtZwTg3svogyqCfz8tXCt.jpg', '100', '90', 1, 0, '2018-01-11 02:48:08', NULL, 1, '', 2),
(13, 31, 2, 'vcvcvcvcv', '<p>vvvcvc</p>\r\n', '', NULL, NULL, '100', '90', 0, 0, '2018-01-11 02:50:52', NULL, 1, '', 0),
(14, 16, 3, 'cvvl,vx,vxvx 2', '<p>dvxvxvx 2 1</p>\r\n', '<p>cvvxv 2 1</p>\r\n', NULL, '5yLtKXQS8l4WiAXK-JoCi4OcCO8rL860.jpg', '100', '90', 0, 0, '2018-01-14 14:05:47', NULL, 2, '', 0),
...
(16, 14, 5, 'asdasd', '<p>asdas</p>\r\n', '<p>asdasd</p>\r\n', NULL, NULL, 'asdasd', '', 1, 0, '2018-02-04 20:30:51', NULL, 5, '', 0),
(17, 14, 5, 'qqqq', '<p>asss</p>\r\n', '<p>ss</p>\r\n', NULL, '78A-GXvjoGccQJMtnaQTr5arLaRvjHD3.jpg', 'w2', '', 1, 0, '2018-02-05 01:34:00', NULL, 6, '', 7);
...
--
-- Volcado de datos para la tabla `anuncios_filtros`
--

INSERT INTO `anuncios_filtros` (`idpf`, `idfiltro`, `idanuncio`, `fecha_registro`) VALUES
(2, 6, 14, '2018-01-14 14:05:47'),
(5, 2, 15, '2018-02-05 01:26:43');
...
INSERT INTO `configuracion` (`idconfiguracion`, `titulo_pagina`, `resumen_pagina`, `meta_palabrasclaves`, `email`, `telefono`, `movil`, `direccion`, `twitter`, `facebook`, `youtube`, `instagram`, `coordenadas`, `cron`) VALUES
...
(6, 'Pequeño', 1, '2018-01-09 13:25:40', 4),
(7, 'Mediano', 1, '2018-01-09 13:25:50', 4),
(8, 'Grande', 1, '2018-01-09 13:28:30', 4),
(9, 'Usado una vez', 1, '2018-01-09 13:29:03', 1),
(10, 'Marca', 1, '2018-01-11 01:16:56', NULL);
...
--
-- Volcado de datos para la tabla `noticias_galeria`
--
...
INSERT INTO `usuarios` (`idusuario`, `nombres`, `apellidos`, `fecha_nacimiento`, `fecha_registro`, `direccion`, `telefono`, `movil`, `ciudad`, `pais`, `email`, `sexo`, `estado`, `tipo`, `contrasena`, `alias`, `foto`, `descripcion`, `facebook`, `twitter`, `youtube`, `instagram`, `intereses`, `nombrenit`, `nit`) VALUES
...
(3, 'maria laura', 'aguilera', '1986-02-08', '2018-01-11 06:00:00', 'calle cochabamba 777 edif mystic depto 2C', '76314443', '76314443', 'santa cruz de la sierra', 'Bolivia', 'mlaguileraf@hotmail.com', 1, 1, 1, '41906b5855bcdbc8d3f425bd133e31b5', 'Maria laura', NULL, 'vdkvndknv', '', '', '', '', '', '', ''),
(4, 'Carlos Hugo', 'Calvi', '1998-09-11', '2018-01-19 18:21:14', 'B/ Estación Argentina Nº 3430', '', '79852022', 'Santa Cruz', 'Bolivia', 'chcalvi@outlook.com', 0, 1, 0, '515c7571504469f7dd78ba10bf3d1c55', NULL, NULL, NULL, '', '', '', '', '', '', ''),
(5, 'Jose Manuel Justiniano Rios', 'prueba', '1940-01-26', '2018-01-25 06:00:00', 'barrio santa ana', '76303932', '1221', 'Santa Cruz', 'prueba', 'jose_manuel3000@hotmail.com', 0, 1, 1, '25f9e794323b453885f5181f1b624d0b', 'acadeima12', 'PyZlSJCLKbT_Zl95ConphOX6qTy4KTtp.jpg', '', '', '', '', '', '', '', ''),
(6, 'Lucas alderete Rios', '', NULL, '2018-02-05 23:35:34', 'Barrio lel', '75025066', '123456', 'Santa cruz', 'Bolivia', 'lucas@gmail.com', 0, 1, 0, 'c408745602ca9f18b0ce8e2a45fac88e', 'Lucqui', NULL, NULL, '', '', '', '', '', '', ''),
(7, 'ana laura cruz', '', '2018-02-06', '2018-02-07 01:23:52', 'calle pailon', '78469746', '78469746', 'santa cruz de la sierra', 'Bolivia', 'analauu.cruz@gmail.com', 0, 1, 0, '18e6a4ba789c2f05b553371cef8bfdb3', 'anita', NULL, '', '', '', '', '', '', '', '');
...
--
ALTER TABLE `anuncios_filtros`
  MODIFY `idpf` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
