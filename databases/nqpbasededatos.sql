...
--
-- Servidor: localhost
-- Tiempo de generación: 19-10-2017 a las 17:43:39
...
CREATE TABLE `noticias` (
  ...
  `foto_portada` varchar(250) DEFAULT '',
  `foto_contenido` varchar(250) NOT NULL DEFAULT '',
...
INSERT INTO `noticias` (`idnoticia`, `idcategoria`, `fecha_noticia`, `fuente`, `foto_portada`, `foto_contenido`, `titulo`, `resumen`, `contenido`, `video`, `estado`, `destacado`, `fecha_registro`) VALUES
