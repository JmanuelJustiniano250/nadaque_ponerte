...
class BannersController extends Controller
{
    ...
    public function actionUp($id)
    {
        if (!Yii::$app->request->isAjax)
            $this->redirect(['index']);
        Funcions::upItem(Banners::find()->where(['idbanner' => $id])->one());
    }
    ...
    public function actionDown($id)
    {
        if (!Yii::$app->request->isAjax)
            $this->redirect(['index']);
        Funcions::downItem(Banners::find()->where(['idbanner' => $id])->one());
    }
    ...
    public function actionEstado($id)
    {
        if (!Yii::$app->request->isAjax)
            $this->redirect(['index']);
        Funcions::estado(Banners::find()->where(['idbanner' => $id])->one());
    }
}
