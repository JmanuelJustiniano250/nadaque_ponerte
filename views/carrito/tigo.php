                ...
                <div class="resp-tabs-container ver_1">
                    <div>
                        <div class="col-md-10 col-xs-11 no-padding-right">
                            <h2 class="text-center">Ingrese su número de su Cuenta Tigo Money</h2>
                            <?php $form = ActiveForm::begin(['id' => 'factura', 'options' => ['class' => ''], 'action' => ['carrito/pasos', 'pasos' => '3'], 'method' => 'post']); ?>
                            <div class="row">
                                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                                    <?= $form->field($model, 'numero')
                                        ->textInput(['class' => 'form-control', 'placeholder' => 'Numero de Tigo'])
                                        ->label(false) ?>
                                </div>
                            </div>
                            <div class="col-sm-4">
