        ...
        <script type="colorScheme" class="swatch active">
{
    ...
    <body paddingwidth="0" paddingheight="0" bgcolor="#efefef"  style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
    <?php $this->beginBody() ?>
                                                                        ...
                                                                        <tr>
                                                                            <td valign="middle">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tbody>
                                                                                    <tr>
                                                                                        <td valign="top" width="100"><img src="<?= $message->embed(Yii::getAlias('@webroot/assets_b/images/logo.png'))?>" alt="Logo" title="Logo" width="100" height="100" data-max-width="100"></td>
                                                                                        ...
                                                                                        <td valign="middle" style='vertical-align: middle;'>
                                                                                            <div class='contentEditableContainer contentTextEditable'>
                                                                                                <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:26;line-height: 39px;font-family: Helvetica Neue;'>
                                                                                                    <h1 class='big'><a target='_blank' href="<?= \yii\helpers\Url::home(true);?>" style='color:#444444'><?= $config['titulo_pagina']; ?></a></h1>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class='contentEditableContainer contentTextEditable'>
                                                                                                <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                                    <p>
                                                                                                        <?= $config['titulo_pagina']; ?> <br/>
                                                                                                        <?= $config['direccion']; ?> <br/>
                                                                                                        <?= $config['telefono'].' '.$config['movil']; ?> <br/>
                                                                                                    </p>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class='contentEditableContainer contentFacebookEditable'>
                                                                                                <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                                                    ...
                                                                                                    <?php
                                                                                                    if($config['instagram']){
                                                                                                        echo "<a href=\"{$config['instagram']}\">Instagram</a>&nbsp;&nbsp;&nbsp;";
                                                                                                    }
                                                                                                    ?>&nbsp;
                                                                                                </div>
                                                                                            </div>
